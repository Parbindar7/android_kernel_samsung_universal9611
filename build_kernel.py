...
def main():
    ...
    parser.add_argument('--target', type=str, required=True, help="Target device (a51/m21/...)", choices=['a51', 'f41', 'm31s', 'm31', 'm21', 'm30s', 'gta4xl', 'gta4xlwifi'])
    ...
    zip_filename = 'Everline-X_{}_{}.zip'.format(
